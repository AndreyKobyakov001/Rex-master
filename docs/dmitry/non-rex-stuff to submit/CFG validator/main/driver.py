...
Note: currently, the driver is quite slow for some some of the tests, especially test4/*. However,
this seems to be caused by the path selection/restricting structures rather than the validator.
"""
